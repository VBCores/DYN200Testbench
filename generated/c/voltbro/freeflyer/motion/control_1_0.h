...
// Source file:   /tmp/tmp.abIE5vZJqA/voltbro/freeflyer/motion/control.1.0.dsdl
// Generated at:  2026-06-10 13:34:12.053508 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef VOLTBRO_FREEFLYER_MOTION_CONTROL_1_0_INCLUDED_
#define VOLTBRO_FREEFLYER_MOTION_CONTROL_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/tmp.abIE5vZJqA/voltbro/freeflyer/motion/control.1.0.dsdl is trying to use a serialization library that was compiled with "
...
#define voltbro_freeflyer_motion_control_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | voltbro.freeflyer.motion.control.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define voltbro_freeflyer_motion_control_1_0_FULL_NAME_             "voltbro.freeflyer.motion.control"
#define voltbro_freeflyer_motion_control_1_0_FULL_NAME_AND_VERSION_ "voltbro.freeflyer.motion.control.1.0"
...
#define voltbro_freeflyer_motion_control_1_0_EXTENT_BYTES_                    28UL
#define voltbro_freeflyer_motion_control_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 28UL
static_assert(voltbro_freeflyer_motion_control_1_0_EXTENT_BYTES_ >= voltbro_freeflyer_motion_control_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

typedef struct
{
    /// uavcan.primitive.scalar.Real32.1.0 front
    uavcan_primitive_scalar_Real32_1_0 front;

    /// uavcan.primitive.scalar.Real32.1.0 back
    uavcan_primitive_scalar_Real32_1_0 back;

    /// uavcan.primitive.scalar.Real32.1.0 side_top
    uavcan_primitive_scalar_Real32_1_0 side_top;

    /// uavcan.primitive.scalar.Real32.1.0 side_bottom
    uavcan_primitive_scalar_Real32_1_0 side_bottom;

    /// uavcan.primitive.scalar.Real32.1.0 top
    uavcan_primitive_scalar_Real32_1_0 _top;

    /// uavcan.primitive.scalar.Real32.1.0 bottom
    uavcan_primitive_scalar_Real32_1_0 bottom;

    /// uavcan.primitive.scalar.Real32.1.0 impeller
    uavcan_primitive_scalar_Real32_1_0 impeller;
} voltbro_freeflyer_motion_control_1_0;
...
///                 @see voltbro_freeflyer_motion_control_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t voltbro_freeflyer_motion_control_1_0_serialize_(
    const voltbro_freeflyer_motion_control_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // uavcan.primitive.scalar.Real32.1.0 front
        ...
        int8_t _err0_ = uavcan_primitive_scalar_Real32_1_0_serialize_(
            &obj->front, &buffer[offset_bits / 8U], &_size_bytes0_);
        if (_err0_ < 0)
        {
            return _err0_;
        }
    ...
    {   // uavcan.primitive.scalar.Real32.1.0 back
        ...
        int8_t _err2_ = uavcan_primitive_scalar_Real32_1_0_serialize_(
            &obj->back, &buffer[offset_bits / 8U], &_size_bytes1_);
        if (_err2_ < 0)
        {
            return _err2_;
        }
    ...
    {   // uavcan.primitive.scalar.Real32.1.0 side_top
        ...
        int8_t _err4_ = uavcan_primitive_scalar_Real32_1_0_serialize_(
            &obj->side_top, &buffer[offset_bits / 8U], &_size_bytes2_);
        if (_err4_ < 0)
        {
            return _err4_;
        }
    ...
    {   // uavcan.primitive.scalar.Real32.1.0 side_bottom
        ...
        int8_t _err6_ = uavcan_primitive_scalar_Real32_1_0_serialize_(
            &obj->side_bottom, &buffer[offset_bits / 8U], &_size_bytes3_);
        if (_err6_ < 0)
        {
            return _err6_;
        }
    ...
    {   // uavcan.primitive.scalar.Real32.1.0 top
        ...
        int8_t _err8_ = uavcan_primitive_scalar_Real32_1_0_serialize_(
            &obj->_top, &buffer[offset_bits / 8U], &_size_bytes4_);
        if (_err8_ < 0)
        {
            return _err8_;
        }
    ...
    {   // uavcan.primitive.scalar.Real32.1.0 bottom
        ...
        int8_t _err10_ = uavcan_primitive_scalar_Real32_1_0_serialize_(
            &obj->bottom, &buffer[offset_bits / 8U], &_size_bytes5_);
        if (_err10_ < 0)
        {
            return _err10_;
        }
    ...
    {   // uavcan.primitive.scalar.Real32.1.0 impeller
        ...
        int8_t _err12_ = uavcan_primitive_scalar_Real32_1_0_serialize_(
            &obj->impeller, &buffer[offset_bits / 8U], &_size_bytes6_);
        if (_err12_ < 0)
        {
            return _err12_;
        }
...
///
/// @returns Negative on error, zero on success.
static inline int8_t voltbro_freeflyer_motion_control_1_0_deserialize_(
    voltbro_freeflyer_motion_control_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.primitive.scalar.Real32.1.0 front
    {
        ...
        const int8_t _err14_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->front, &buffer[offset_bits / 8U], &_size_bytes7_);
        if (_err14_ < 0)
        {
            return _err14_;
        }
    ...
    // uavcan.primitive.scalar.Real32.1.0 back
    {
        ...
        const int8_t _err15_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->back, &buffer[offset_bits / 8U], &_size_bytes8_);
        if (_err15_ < 0)
        {
            return _err15_;
        }
    ...
    // uavcan.primitive.scalar.Real32.1.0 side_top
    {
        ...
        const int8_t _err16_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->side_top, &buffer[offset_bits / 8U], &_size_bytes9_);
        if (_err16_ < 0)
        {
            return _err16_;
        }
    ...
    // uavcan.primitive.scalar.Real32.1.0 side_bottom
    {
        ...
        const int8_t _err17_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->side_bottom, &buffer[offset_bits / 8U], &_size_bytes10_);
        if (_err17_ < 0)
        {
            return _err17_;
        }
    ...
    // uavcan.primitive.scalar.Real32.1.0 top
    {
        ...
        const int8_t _err18_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->_top, &buffer[offset_bits / 8U], &_size_bytes11_);
        if (_err18_ < 0)
        {
            return _err18_;
        }
    ...
    // uavcan.primitive.scalar.Real32.1.0 bottom
    {
        ...
        const int8_t _err19_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->bottom, &buffer[offset_bits / 8U], &_size_bytes12_);
        if (_err19_ < 0)
        {
            return _err19_;
        }
    ...
    // uavcan.primitive.scalar.Real32.1.0 impeller
    {
        ...
        const int8_t _err20_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
            &out_obj->impeller, &buffer[offset_bits / 8U], &_size_bytes13_);
        if (_err20_ < 0)
        {
            return _err20_;
        }
...
static inline void voltbro_freeflyer_motion_control_1_0_initialize_(voltbro_freeflyer_motion_control_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = voltbro_freeflyer_motion_control_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // VOLTBRO_FREEFLYER_MOTION_CONTROL_1_0_INCLUDED_
