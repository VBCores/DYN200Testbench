...
// Source file:   /tmp/tmp.abIE5vZJqA/voltbro/foc/state_simple.1.0.dsdl
// Generated at:  2026-06-10 13:34:12.136463 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef VOLTBRO_FOC_STATE_SIMPLE_1_0_INCLUDED_
#define VOLTBRO_FOC_STATE_SIMPLE_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/tmp.abIE5vZJqA/voltbro/foc/state_simple.1.0.dsdl is trying to use a serialization library that was compiled with "
...
#define voltbro_foc_state_simple_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | voltbro.foc.state_simple.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define voltbro_foc_state_simple_1_0_FULL_NAME_             "voltbro.foc.state_simple"
#define voltbro_foc_state_simple_1_0_FULL_NAME_AND_VERSION_ "voltbro.foc.state_simple.1.0"
...
#define voltbro_foc_state_simple_1_0_EXTENT_BYTES_                    36UL
#define voltbro_foc_state_simple_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 36UL
static_assert(voltbro_foc_state_simple_1_0_EXTENT_BYTES_ >= voltbro_foc_state_simple_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
...
typedef struct
{
    ...
    uavcan_si_unit_voltage_Scalar_1_0 bus_voltage;

    /// uavcan.si.unit.temperature.Scalar.1.0 mcu_temp
    uavcan_si_unit_temperature_Scalar_1_0 mcu_temp;

    /// uavcan.si.unit.temperature.Scalar.1.0 stator_temp
    uavcan_si_unit_temperature_Scalar_1_0 stator_temp;

    /// uavcan.primitive.scalar.Bit.1.0 has_fault
    uavcan_primitive_scalar_Bit_1_0 has_fault;
} voltbro_foc_state_simple_1_0;
...
///                 @see voltbro_foc_state_simple_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t voltbro_foc_state_simple_1_0_serialize_(
    const voltbro_foc_state_simple_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // uavcan.si.unit.torque.Scalar.1.0 torque
        ...
        int8_t _err6_ = uavcan_si_unit_torque_Scalar_1_0_serialize_(
            &obj->_torque, &buffer[offset_bits / 8U], &_size_bytes3_);
        if (_err6_ < 0)
        {
            return _err6_;
        }
    ...
    {   // uavcan.si.unit.electric_current.Scalar.1.0 current
        ...
        int8_t _err8_ = uavcan_si_unit_electric_current_Scalar_1_0_serialize_(
            &obj->current, &buffer[offset_bits / 8U], &_size_bytes4_);
        if (_err8_ < 0)
        {
            return _err8_;
        }
    ...
    {   // uavcan.si.unit.voltage.Scalar.1.0 bus_voltage
        ...
        int8_t _err10_ = uavcan_si_unit_voltage_Scalar_1_0_serialize_(
            &obj->bus_voltage, &buffer[offset_bits / 8U], &_size_bytes5_);
        if (_err10_ < 0)
        {
            return _err10_;
        }
    ...
    {   // uavcan.si.unit.temperature.Scalar.1.0 mcu_temp
        ...
        int8_t _err12_ = uavcan_si_unit_temperature_Scalar_1_0_serialize_(
            &obj->mcu_temp, &buffer[offset_bits / 8U], &_size_bytes6_);
        if (_err12_ < 0)
        {
            return _err12_;
        }
    ...
    {   // uavcan.si.unit.temperature.Scalar.1.0 stator_temp
        ...
        int8_t _err14_ = uavcan_si_unit_temperature_Scalar_1_0_serialize_(
            &obj->stator_temp, &buffer[offset_bits / 8U], &_size_bytes7_);
        if (_err14_ < 0)
        {
            return _err14_;
        }
    ...
    {   // uavcan.primitive.scalar.Bit.1.0 has_fault
        ...
        int8_t _err16_ = uavcan_primitive_scalar_Bit_1_0_serialize_(
            &obj->has_fault, &buffer[offset_bits / 8U], &_size_bytes8_);
        if (_err16_ < 0)
        {
            return _err16_;
        }
...
///
/// @returns Negative on error, zero on success.
static inline int8_t voltbro_foc_state_simple_1_0_deserialize_(
    voltbro_foc_state_simple_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.time.SynchronizedTimestamp.1.0 timestamp
    {
        ...
        const int8_t _err18_ = uavcan_time_SynchronizedTimestamp_1_0_deserialize_(
            &out_obj->timestamp, &buffer[offset_bits / 8U], &_size_bytes9_);
        if (_err18_ < 0)
        {
            return _err18_;
        }
    ...
    // uavcan.si.unit.angle.Scalar.1.0 angle
    {
        ...
        const int8_t _err19_ = uavcan_si_unit_angle_Scalar_1_0_deserialize_(
            &out_obj->angle, &buffer[offset_bits / 8U], &_size_bytes10_);
        if (_err19_ < 0)
        {
            return _err19_;
        }
    ...
    // uavcan.si.unit.angular_velocity.Scalar.1.0 velocity
    {
        ...
        const int8_t _err20_ = uavcan_si_unit_angular_velocity_Scalar_1_0_deserialize_(
            &out_obj->velocity, &buffer[offset_bits / 8U], &_size_bytes11_);
        if (_err20_ < 0)
        {
            return _err20_;
        }
    ...
    // uavcan.si.unit.torque.Scalar.1.0 torque
    {
        ...
        const int8_t _err21_ = uavcan_si_unit_torque_Scalar_1_0_deserialize_(
            &out_obj->_torque, &buffer[offset_bits / 8U], &_size_bytes12_);
        if (_err21_ < 0)
        {
            return _err21_;
        }
    ...
    // uavcan.si.unit.electric_current.Scalar.1.0 current
    {
        ...
        const int8_t _err22_ = uavcan_si_unit_electric_current_Scalar_1_0_deserialize_(
            &out_obj->current, &buffer[offset_bits / 8U], &_size_bytes13_);
        if (_err22_ < 0)
        {
            return _err22_;
        }
    ...
    // uavcan.si.unit.voltage.Scalar.1.0 bus_voltage
    {
        ...
        const int8_t _err23_ = uavcan_si_unit_voltage_Scalar_1_0_deserialize_(
            &out_obj->bus_voltage, &buffer[offset_bits / 8U], &_size_bytes14_);
        if (_err23_ < 0)
        {
            return _err23_;
        }
    ...
    // uavcan.si.unit.temperature.Scalar.1.0 mcu_temp
    {
        ...
        const int8_t _err24_ = uavcan_si_unit_temperature_Scalar_1_0_deserialize_(
            &out_obj->mcu_temp, &buffer[offset_bits / 8U], &_size_bytes15_);
        if (_err24_ < 0)
        {
            return _err24_;
        }
    ...
    // uavcan.si.unit.temperature.Scalar.1.0 stator_temp
    {
        ...
        const int8_t _err25_ = uavcan_si_unit_temperature_Scalar_1_0_deserialize_(
            &out_obj->stator_temp, &buffer[offset_bits / 8U], &_size_bytes16_);
        if (_err25_ < 0)
        {
            return _err25_;
        }
    ...
    // uavcan.primitive.scalar.Bit.1.0 has_fault
    {
        ...
        const int8_t _err26_ = uavcan_primitive_scalar_Bit_1_0_deserialize_(
            &out_obj->has_fault, &buffer[offset_bits / 8U], &_size_bytes17_);
        if (_err26_ < 0)
        {
            return _err26_;
        }
...
static inline void voltbro_foc_state_simple_1_0_initialize_(voltbro_foc_state_simple_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = voltbro_foc_state_simple_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // VOLTBRO_FOC_STATE_SIMPLE_1_0_INCLUDED_
