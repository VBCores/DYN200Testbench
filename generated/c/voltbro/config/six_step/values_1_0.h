...
// Source file:   /tmp/tmp.abIE5vZJqA/voltbro/config/six_step/values.1.0.dsdl
// Generated at:  2026-06-10 13:34:12.098414 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/tmp.abIE5vZJqA/voltbro/config/six_step/values.1.0.dsdl is trying to use a serialization library that was compiled with "
    ...
    const voltbro_config_six_step_values_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // voltbro.config.six_step.pid_config.1.0 velocity_pid
        ...
        const int8_t _err33_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _size_bytes16_, 32U);
        if (_err33_ < 0)
        {
            return _err33_;
        }
    ...
    if (offset_bits % 8U != 0U)  // Pad to 8 bits. TODO: Eliminate redundant padding checks.
    {
        ...
        const int8_t _err34_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, 0U, _pad16_);  // Optimize?
        if (_err34_ < 0)
        {
            return _err34_;
        }
    ...
    {   // voltbro.config.six_step.pid_config.1.0 current_pid
        ...
        // Constant delimiter header can be written ahead of the nested object.
        const int8_t _err36_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _size_bytes17_, 32U);
        if (_err36_ < 0)
        {
            return _err36_;
        }
        offset_bits += 32U;
        int8_t _err35_ = voltbro_config_six_step_pid_config_1_0_serialize_(
    ...
    if (offset_bits % 8U != 0U)  // Pad to 8 bits. TODO: Eliminate redundant padding checks.
    {
        ...
        const int8_t _err37_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, 0U, _pad17_);  // Optimize?
        if (_err37_ < 0)
        {
            return _err37_;
        }
    ...
    voltbro_config_six_step_values_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.primitive.scalar.Integer8.1.0 predict_change
    {
        ...
        const int8_t _err38_ = uavcan_primitive_scalar_Integer8_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Integer8.1.0 detect_stall
    {
        ...
        const int8_t _err39_ = uavcan_primitive_scalar_Integer8_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Real32.1.0 I_mult
    {
        ...
        const int8_t _err47_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Integer32.1.0 max_PWM_per_s
    {
        ...
        const int8_t _err49_ = uavcan_primitive_scalar_Integer32_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Real32.1.0 max_current
    {
        ...
        const int8_t _err52_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Real32.1.0 stall_current
    {
        ...
        const int8_t _err53_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
    ...
    // voltbro.config.six_step.pid_config.1.0 velocity_pid
    {
        ...
        const int8_t _err54_ = voltbro_config_six_step_pid_config_1_0_deserialize_(
    ...
    // voltbro.config.six_step.pid_config.1.0 current_pid
    {
        ...
        const int8_t _err55_ = voltbro_config_six_step_pid_config_1_0_deserialize_(
