...
// Source file:   /tmp/tmp.abIE5vZJqA/voltbro/config/six_step/log_item.1.0.dsdl
// Generated at:  2026-06-10 13:34:12.083391 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/tmp.abIE5vZJqA/voltbro/config/six_step/log_item.1.0.dsdl is trying to use a serialization library that was compiled with "
    ...
    const voltbro_config_six_step_log_item_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // voltbro.config.six_step.pid_report.1.0 velocity_report
        ...
        const int8_t _err19_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _size_bytes9_, 32U);
        if (_err19_ < 0)
        {
            return _err19_;
        }
    ...
    if (offset_bits % 8U != 0U)  // Pad to 8 bits. TODO: Eliminate redundant padding checks.
    {
        ...
        const int8_t _err20_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, 0U, _pad9_);  // Optimize?
        if (_err20_ < 0)
        {
            return _err20_;
        }
    ...
    {   // voltbro.config.six_step.pid_report.1.0 current_report
        ...
        // Constant delimiter header can be written ahead of the nested object.
        const int8_t _err22_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _size_bytes10_, 32U);
        if (_err22_ < 0)
        {
            return _err22_;
        }
        offset_bits += 32U;
        int8_t _err21_ = voltbro_config_six_step_pid_report_1_0_serialize_(
    ...
    voltbro_config_six_step_log_item_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.primitive.scalar.Integer8.1.0 is_on
    {
        ...
        const int8_t _err24_ = uavcan_primitive_scalar_Integer8_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Integer8.1.0 is_stalling
    {
        ...
        const int8_t _err25_ = uavcan_primitive_scalar_Integer8_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Real32.1.0 speed
    {
        ...
        const int8_t _err27_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Integer32.1.0 PWM
    {
        ...
        const int8_t _err29_ = uavcan_primitive_scalar_Integer32_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Real32.1.0 I_B
    {
        ...
        const int8_t _err31_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
    ...
    // uavcan.primitive.scalar.Real32.1.0 I_C
    {
        ...
        const int8_t _err32_ = uavcan_primitive_scalar_Real32_1_0_deserialize_(
    ...
    // voltbro.config.six_step.pid_report.1.0 velocity_report
    {
        ...
        const int8_t _err33_ = voltbro_config_six_step_pid_report_1_0_deserialize_(
    ...
    // voltbro.config.six_step.pid_report.1.0 current_report
    {
        ...
        const int8_t _err34_ = voltbro_config_six_step_pid_report_1_0_deserialize_(
