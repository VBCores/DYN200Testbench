...
// Source file:   /tmp/tmp.abIE5vZJqA/voltbro/hmi/led_service.1.0.dsdl
// Generated at:  2026-06-10 13:34:12.122465 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef VOLTBRO_HMI_LED_SERVICE_1_0_INCLUDED_
#define VOLTBRO_HMI_LED_SERVICE_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/tmp/tmp.abIE5vZJqA/voltbro/hmi/led_service.1.0.dsdl is trying to use a serialization library that was compiled with "
...
///                 @see voltbro_hmi_led_service_Request_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t voltbro_hmi_led_service_Request_1_0_serialize_(
    const voltbro_hmi_led_service_Request_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // uavcan.si.unit.duration.Scalar.1.0 duration
        ...
        int8_t _err6_ = uavcan_si_unit_duration_Scalar_1_0_serialize_(
            &obj->duration, &buffer[offset_bits / 8U], &_size_bytes3_);
        if (_err6_ < 0)
        {
            return _err6_;
        }
    ...
    {   // uavcan.si.unit.frequency.Scalar.1.0 frequency
        ...
        int8_t _err8_ = uavcan_si_unit_frequency_Scalar_1_0_serialize_(
            &obj->frequency, &buffer[offset_bits / 8U], &_size_bytes4_);
        if (_err8_ < 0)
        {
            return _err8_;
        }
...
///
/// @returns Negative on error, zero on success.
static inline int8_t voltbro_hmi_led_service_Request_1_0_deserialize_(
    voltbro_hmi_led_service_Request_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
...
static inline void voltbro_hmi_led_service_Request_1_0_initialize_(voltbro_hmi_led_service_Request_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = voltbro_hmi_led_service_Request_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
/// instead of the extent because it provides a tighter bound of the object size; it is safe because the concrete type
/// is always known during serialization (unlike deserialization). If not sure, use extent everywhere.
#define voltbro_hmi_led_service_Response_1_0_EXTENT_BYTES_                    1UL
#define voltbro_hmi_led_service_Response_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 1UL
static_assert(voltbro_hmi_led_service_Response_1_0_EXTENT_BYTES_ >= voltbro_hmi_led_service_Response_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");
...
} voltbro_hmi_led_service_Response_1_0;
...
///
/// @param buffer   The destination buffer. There are no alignment requirements.
///                 @see voltbro_hmi_led_service_Response_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
/// @param inout_buffer_size_bytes  When calling, this is a pointer to the size of the buffer in bytes.
///                                 Upon return this value will be updated with the size of the constructed serialized
///                                 representation (in bytes); this value is then to be passed over to the transport
...
///
/// @returns Negative on error, zero on success.
static inline int8_t voltbro_hmi_led_service_Response_1_0_serialize_(
    const voltbro_hmi_led_service_Response_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    if ((obj == NULL) || (buffer == NULL) || (inout_buffer_size_bytes == NULL))
    {
        return -NUNAVUT_ERROR_INVALID_ARGUMENT;
...
///
/// @returns Negative on error, zero on success.
static inline int8_t voltbro_hmi_led_service_Response_1_0_deserialize_(
    voltbro_hmi_led_service_Response_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    if ((out_obj == NULL) || (inout_buffer_size_bytes == NULL) || ((buffer == NULL) && (0 != *inout_buffer_size_bytes)))
    {
        return -NUNAVUT_ERROR_INVALID_ARGUMENT;
...
/// array beyond its length are left uninitialized; aliased union memory that is not used by the first union field
/// is left uninitialized, etc. If full zero-initialization is desired, just use memset(&obj, 0, sizeof(obj)).
static inline void voltbro_hmi_led_service_Response_1_0_initialize_(voltbro_hmi_led_service_Response_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = voltbro_hmi_led_service_Response_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // VOLTBRO_HMI_LED_SERVICE_1_0_INCLUDED_
