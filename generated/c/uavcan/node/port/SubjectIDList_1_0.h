...
// Source file:   /srv/codex-work/torque_testbench/DYN200TestBench/Drivers/cyphal_types/public_regulated_data_types/uavcan/node/port/SubjectIDList.1.0.dsdl
// Generated at:  2026-06-08 14:14:44.587813 UTC
// Is deprecated: no
// Fixed port-ID: None
...
#ifndef UAVCAN_NODE_PORT_SUBJECT_ID_LIST_1_0_INCLUDED_
#define UAVCAN_NODE_PORT_SUBJECT_ID_LIST_1_0_INCLUDED_
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/srv/codex-work/torque_testbench/DYN200TestBench/Drivers/cyphal_types/public_regulated_data_types/uavcan/node/port/SubjectIDList.1.0.dsdl is trying to use a serialization library that was compiled with "
...
#define uavcan_node_port_SubjectIDList_1_0_HAS_FIXED_PORT_ID_ false

// +-------------------------------------------------------------------------------------------------------------------+
// | uavcan.node.port.SubjectIDList.1.0
// +-------------------------------------------------------------------------------------------------------------------+
#define uavcan_node_port_SubjectIDList_1_0_FULL_NAME_             "uavcan.node.port.SubjectIDList"
#define uavcan_node_port_SubjectIDList_1_0_FULL_NAME_AND_VERSION_ "uavcan.node.port.SubjectIDList.1.0"
...
#define uavcan_node_port_SubjectIDList_1_0_EXTENT_BYTES_                    4097UL
#define uavcan_node_port_SubjectIDList_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_ 1025UL
static_assert(uavcan_node_port_SubjectIDList_1_0_EXTENT_BYTES_ >= uavcan_node_port_SubjectIDList_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_,
              "Internal constraint violation");

/// saturated uint16 CAPACITY = 8192
#define uavcan_node_port_SubjectIDList_1_0_CAPACITY (8192U)

/// Array metadata for: bool[8192] mask
#define uavcan_node_port_SubjectIDList_1_0_mask_ARRAY_CAPACITY_           8192U
#define uavcan_node_port_SubjectIDList_1_0_mask_ARRAY_IS_VARIABLE_LENGTH_ false

/// Array metadata for: uavcan.node.port.SubjectID.1.0[<=255] sparse_list
#define uavcan_node_port_SubjectIDList_1_0_sparse_list_ARRAY_CAPACITY_           255U
#define uavcan_node_port_SubjectIDList_1_0_sparse_list_ARRAY_IS_VARIABLE_LENGTH_ true
...
typedef struct
{
    union  /// The union is placed first to ensure that the active element address equals the struct address.
    {
        ...
        {
            uavcan_node_port_SubjectID_1_0 elements[uavcan_node_port_SubjectIDList_1_0_sparse_list_ARRAY_CAPACITY_];
            size_t count;
        } sparse_list;
...
#define uavcan_node_port_SubjectIDList_1_0_UNION_OPTION_COUNT_ 3U
...
///                 @see uavcan_node_port_SubjectIDList_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t uavcan_node_port_SubjectIDList_1_0_serialize_(
    const uavcan_node_port_SubjectIDList_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    if (0U == obj->_tag_)  // bool[8192] mask
    {
...
///
/// @returns Negative on error, zero on success.
static inline int8_t uavcan_node_port_SubjectIDList_1_0_deserialize_(
    uavcan_node_port_SubjectIDList_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    offset_bits += 8U;
    if (0U == out_obj->_tag_)  // bool[8192] mask
    {
...
static inline void uavcan_node_port_SubjectIDList_1_0_initialize_(uavcan_node_port_SubjectIDList_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = uavcan_node_port_SubjectIDList_1_0_deserialize_(out_obj, &buf, &size_bytes);

        (void) err;
    }
}
/// Mark option "mask" active without initializing it. Does nothing if @param obj is NULL.
static inline void uavcan_node_port_SubjectIDList_1_0_select_mask_(uavcan_node_port_SubjectIDList_1_0* const obj)
{
    if (obj != NULL)
    {
        obj->_tag_ = 0;
...
static inline bool uavcan_node_port_SubjectIDList_1_0_is_mask_(const uavcan_node_port_SubjectIDList_1_0* const obj)
{
    return ((obj != NULL) && (obj->_tag_ == 0));
}

/// Mark option "sparse_list" active without initializing it. Does nothing if @param obj is NULL.
static inline void uavcan_node_port_SubjectIDList_1_0_select_sparse_list_(uavcan_node_port_SubjectIDList_1_0* const obj)
{
    if (obj != NULL)
    {
        obj->_tag_ = 1;
...
static inline bool uavcan_node_port_SubjectIDList_1_0_is_sparse_list_(const uavcan_node_port_SubjectIDList_1_0* const obj)
{
    return ((obj != NULL) && (obj->_tag_ == 1));
}

/// Mark option "total" active without initializing it. Does nothing if @param obj is NULL.
static inline void uavcan_node_port_SubjectIDList_1_0_select_total_(uavcan_node_port_SubjectIDList_1_0* const obj)
{
    if (obj != NULL)
    {
        obj->_tag_ = 2;
...
static inline bool uavcan_node_port_SubjectIDList_1_0_is_total_(const uavcan_node_port_SubjectIDList_1_0* const obj)
{
...
#endif
#endif // UAVCAN_NODE_PORT_SUBJECT_ID_LIST_1_0_INCLUDED_
