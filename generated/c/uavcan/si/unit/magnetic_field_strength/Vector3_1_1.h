...
// Source file:   /srv/codex-work/torque_testbench/DYN200TestBench/Drivers/cyphal_types/public_regulated_data_types/uavcan/si/unit/magnetic_field_strength/Vector3.1.1.dsdl
// Generated at:  2026-06-08 14:14:44.823155 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/srv/codex-work/torque_testbench/DYN200TestBench/Drivers/cyphal_types/public_regulated_data_types/uavcan/si/unit/magnetic_field_strength/Vector3.1.1.dsdl is trying to use a serialization library that was compiled with "
    ...
    const uavcan_si_unit_magnetic_field_strength_Vector3_1_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated float32[3] ampere_per_meter
        ...
        for (size_t _index0_ = 0U; _index0_ < 3UL; ++_index0_)
        {
            ...
            const int8_t _err0_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->ampere_per_meter[_index0_]);
            if (_err0_ < 0)
            {
                return _err0_;
            }
